...
public class IMGLYOrientationEditorViewController: IMGLYSubEditorViewController {
    ...
    public private(set) lazy var rotateLeftButton: IMGLYImageCaptionButton = {
        ...
        button.addTarget(self, action: #selector(rotateLeft), forControlEvents: .TouchUpInside)
        return button
        }()
    ...
    public private(set) lazy var rotateRightButton: IMGLYImageCaptionButton = {
        ...
        button.translatesAutoresizingMaskIntoConstraints = false
        button.addTarget(self, action: #selector(rotateRight), forControlEvents: .TouchUpInside)
        return button
        }()
    ...
    public private(set) lazy var flipHorizontallyButton: IMGLYImageCaptionButton = {
        ...
        button.translatesAutoresizingMaskIntoConstraints = false
        button.addTarget(self, action: #selector(flipHorizontally), forControlEvents: .TouchUpInside)
        return button
        }()
    ...
    public private(set) lazy var flipVerticallyButton: IMGLYImageCaptionButton = {
        ...
        button.translatesAutoresizingMaskIntoConstraints = false
        button.addTarget(self, action: #selector(flipVertically), forControlEvents: .TouchUpInside)
        return button
        }()
