...
public class IMGLYFocusEditorViewController: IMGLYSubEditorViewController {
    ...
    public private(set) lazy var offButton: IMGLYImageCaptionButton = {
        ...
        button.addTarget(self, action: #selector(turnOff), forControlEvents: .TouchUpInside)
        return button
        }()
    ...
    public private(set) lazy var linearButton: IMGLYImageCaptionButton = {
        ...
        button.translatesAutoresizingMaskIntoConstraints = false
        button.addTarget(self, action: #selector(activateLinear), forControlEvents: .TouchUpInside)
        return button
        }()
    ...
    public private(set) lazy var radialButton: IMGLYImageCaptionButton = {
        ...
        button.translatesAutoresizingMaskIntoConstraints = false
        button.addTarget(self, action: #selector(activateRadial), forControlEvents: .TouchUpInside)
        return button
        }()
