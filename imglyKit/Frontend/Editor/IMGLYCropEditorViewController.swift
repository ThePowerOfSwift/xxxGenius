...
public class IMGLYCropEditorViewController: IMGLYSubEditorViewController {
    ...
    public private(set) lazy var freeRatioButton: IMGLYImageCaptionButton = {
        ...
        button.addTarget(self, action: #selector(activateFreeRatio), forControlEvents: .TouchUpInside)
        return button
        }()
    ...
    public private(set) lazy var oneToOneRatioButton: IMGLYImageCaptionButton = {
        ...
        button.translatesAutoresizingMaskIntoConstraints = false
        button.addTarget(self, action: #selector(activateOneToOneRatio), forControlEvents: .TouchUpInside)
        return button
        }()
    ...
    public private(set) lazy var fourToThreeRatioButton: IMGLYImageCaptionButton = {
        ...
        button.translatesAutoresizingMaskIntoConstraints = false
        button.addTarget(self, action: #selector(activateFourToThreeRatio), forControlEvents: .TouchUpInside)
        return button
        }()
    ...
    public private(set) lazy var sixteenToNineRatioButton: IMGLYImageCaptionButton = {
        ...
        button.translatesAutoresizingMaskIntoConstraints = false
        button.addTarget(self, action: #selector(activateSixteenToNineRatio), forControlEvents: .TouchUpInside)
        return button
        }()
